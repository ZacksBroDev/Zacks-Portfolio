      ...
      projects: [
        {
          ...
          bullets: [
            "Developed a responsive e-commerce SaaS platform for an independent music producer with 50+ digital assets, enabling direct-to-consumer sales using JWT authentication and MongoDB.",
            "Implemented layered application security, including rate limiting, CSRF protection, input validation, and role-based access control for admin/user management.",
          ],
        },
      ],
    },
      ...
      projects: [
        {
          ...
          bullets: [
            "Built a centralized training platform for a martial arts school serving 100+ students, consolidating schedules, instructional videos, and resources into one system and reducing manual coordination by ~50%; built with React 19, Vite, and AWS Amplify.",
          ],
        },
        {
          title: "The Futons",
          ...
          bullets: [
            "Developed a performance-optimized static website for a local band featuring a responsive photo gallery with 60+ concert images, using lazy loading and progressive image rendering (Cloudinary, JavaScript, HTML5, CSS3).",
          ],
        },
      ],
    },
  ...
  selfDevelopment: [
    {
      ...
      bullets: [
        "Training program to practice and improve software engineering skills through structured coursework, projects, and community engagement.",
        "Interact with community members and contribute to open-source projects with teams across the nation.",
        "Ask and answer questions about software engineering and attend tech meetups in local cities.",
      ],
    },
  ],
  certifications: [
